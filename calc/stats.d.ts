...
export declare const Stats: {
    ...
    calcStat(gen: Generation, stat: StatName, base: number, iv: number, ev: number, level: number, nature?: string): number;
    calcStatADV(natures: Natures, stat: StatName, base: number, iv: number, ev: number, level: number, nature?: string): number;
